-- Fix: Also add the user to tenant_members when setting up a new college
...
BEGIN
  ...
  -- Crucial Fix: Add the user to tenant_members so they actually belong to the tenant!
  INSERT INTO public.tenant_members (tenant_id, user_id, campus_id, status)
  VALUES (v_tenant_id, v_user_id, v_campus_id, 'active');
